...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../Add student/student.css" />
      ...
      <div class="content">
        ...
        <div class="activities">
          ...
          <div class="management">
            <div class="mgn-title">
              <h2 class="hedin">Manage Student Account</h2>
              <div class="create-stud">
                ...
                <button class="okay">Delete</button>
              </div>
            </div>
            <div class="stud" id="crate">
              <div class="stud-dtls">
                <form action="post" class="stud-info">
                  ...
                  <input class="okay" value="submit" name="submit" /><br />
                </form>
              </div>
            </div>
          </div>
